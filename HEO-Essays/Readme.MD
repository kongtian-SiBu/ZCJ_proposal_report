...
编号5这篇文章研究了从地球到月球的整个弧段(during the whole trajectory to reach the Moon)，使用“Spirent GSS8000”模拟器对GPS L1CA、L5导频、Galileo E1和E5导频进行仿真。接收机轨迹设置详见table2、Fig1、Fig2和Fig3。可以看到远地点恰好是月球轨道的高度。
